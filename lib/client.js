...
function variantTitle(toolName) {
...
function deriveSummary(variant, argsRaw) {
	...
	if (parsed === void 0) return firstLine$1(argsRaw);
	...
	for (const value of Object.values(parsed)) if (typeof value === "string" && value !== "") return firstLine$1(value);
...
const VARIANT_ICONS = {
	search: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(__deepseek_ai_dsh_client_ui_primitives.IconSearchOutlineRegular, { size: 14 }),
	read: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(__deepseek_ai_dsh_client_ui_primitives.IconBrowseOutlineRegular, { size: 14 }),
	bash: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(__deepseek_ai_dsh_client_ui_primitives.IconApiOutlineRegular, { size: 14 }),
	write: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(__deepseek_ai_dsh_client_ui_primitives.IconEditOutlineRegular, { size: 14 }),
	edit: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(__deepseek_ai_dsh_client_ui_primitives.IconEditOutlineRegular, { size: 14 }),
	code: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(__deepseek_ai_dsh_client_ui_primitives.IconCodeOutlineRegular, { size: 14 }),
	others: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(__deepseek_ai_dsh_client_ui_primitives.IconSparkleRegular, { size: 14 })
};
/**
...
*/
function PreparingMergedRow({ toolName, useToolCallArgumentsPartial, t }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(__deepseek_ai_dsh_client_ui_primitives.DisclosureRow, {
			rowClassName: "mtc-title-row",
			titleClassName: "mtc-title",
			leadingClassName: "mtc-leading",
			chevronClassName: "mtc-chevron",
...
*/
function DispatchedMergedRow({ callId, toolName, block, cwd, home, openFile, inspect, t, cfg, useChat }) {
...
*/
function MergedToolRow(props) {
	if (props.phase === "preparing") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PreparingMergedRow, { ...props });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DispatchedMergedRow, { ...props });
}
