...
const Config = Schema.object({
	...
	groupBy: Schema.union(["adjacent", "step"]).default("adjacent").description("adjacent merges any consecutive run in the chat flow; step merges only calls within one agent step."),
	maxGroupSize: Schema.natural().default(8).description("Maximum calls per merged group; excess calls start a new group.")
});
/**
